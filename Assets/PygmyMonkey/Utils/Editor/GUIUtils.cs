...
namespace PygmyMonkey.Utils
{
	public static class GUIUtils
	{
		...
		public static bool DrawLeftToggle(string name, bool isEnabled)
		{
			#if UNITY_4_1 || UNITY_4_2
			bool enabled = isEnabled;
			EditorGUILayout.BeginHorizontal();
			enabled = EditorGUILayout.Toggle(isEnabled, GUILayout.Width(15f));
			EditorGUILayout.LabelField(name);
			EditorGUILayout.EndHorizontal();
			return enabled;
			#else
			return EditorGUILayout.ToggleLeft(" " + name, isEnabled);
			#endif
		}
		
		public static bool DrawLeftToggle(GUIContent guiContent, bool isEnabled)
		{
			#if UNITY_4_1 || UNITY_4_2
			bool enabled = isEnabled;
			EditorGUILayout.BeginHorizontal();
			...
			return enabled;
			#else
			return EditorGUILayout.ToggleLeft(guiContent, isEnabled);
			#endif
		}
